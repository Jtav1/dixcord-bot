    ...
    endpoints: {
      ...
      triggerResponses: {
        ...
        routes: [
          ...
          "POST /api/trigger-responses/triggers (body: { trigger_string, selection_mode?, responses: [{ response_string, order? }] })",
          "PUT /api/trigger-responses/triggers/:id (body: { selection_mode?, responses?: [{ id?: linkId, order? } | { response_string, order? }] })",
