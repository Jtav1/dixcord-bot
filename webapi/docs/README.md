...
| POST | `/api/message-processing/emoji-frequency-sync` | bot/admin | Delete guild_emojis rows misattributed to another guild, then copy emoji_frequency into guild_emojis for this guild (body: `{ app, guildId }`) |
